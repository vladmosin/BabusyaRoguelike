...
public final class GameGrpc {
  ...
  public static final String SERVICE_NAME = "inc.roguelike.babusya.network.Game";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Empty,
      inc.roguelike.babusya.network.Message> getReceiveMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "receiveMessage",
      requestType = inc.roguelike.babusya.network.Empty.class,
      responseType = inc.roguelike.babusya.network.Message.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Empty,
      inc.roguelike.babusya.network.Message> getReceiveMessageMethod() {
    io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Empty, inc.roguelike.babusya.network.Message> getReceiveMessageMethod;
      ...
      synchronized (GameGrpc.class) {
        if ((getReceiveMessageMethod = GameGrpc.getReceiveMessageMethod) == null) {
          GameGrpc.getReceiveMessageMethod = getReceiveMessageMethod =
              io.grpc.MethodDescriptor.<inc.roguelike.babusya.network.Empty, inc.roguelike.babusya.network.Message>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "receiveMessage"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  inc.roguelike.babusya.network.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  inc.roguelike.babusya.network.Message.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Message,
      inc.roguelike.babusya.network.Empty> getSendMessageMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sendMessage",
      requestType = inc.roguelike.babusya.network.Message.class,
      responseType = inc.roguelike.babusya.network.Empty.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Message,
      inc.roguelike.babusya.network.Empty> getSendMessageMethod() {
    io.grpc.MethodDescriptor<inc.roguelike.babusya.network.Message, inc.roguelike.babusya.network.Empty> getSendMessageMethod;
    if ((getSendMessageMethod = GameGrpc.getSendMessageMethod) == null) {
      synchronized (GameGrpc.class) {
        if ((getSendMessageMethod = GameGrpc.getSendMessageMethod) == null) {
          GameGrpc.getSendMessageMethod = getSendMessageMethod =
              io.grpc.MethodDescriptor.<inc.roguelike.babusya.network.Message, inc.roguelike.babusya.network.Empty>newBuilder()
  ...
  public static abstract class GameImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void receiveMessage(inc.roguelike.babusya.network.Empty request,
        io.grpc.stub.StreamObserver<inc.roguelike.babusya.network.Message> responseObserver) {
      asyncUnimplementedUnaryCall(getReceiveMessageMethod(), responseObserver);
    }

    /**
     */
    public void sendMessage(inc.roguelike.babusya.network.Message request,
        io.grpc.stub.StreamObserver<inc.roguelike.babusya.network.Empty> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                inc.roguelike.babusya.network.Empty,
                inc.roguelike.babusya.network.Message>(
  ...
  public static final class GameBlockingStub extends io.grpc.stub.AbstractBlockingStub<GameBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<inc.roguelike.babusya.network.Message> receiveMessage(
        inc.roguelike.babusya.network.Empty request) {
    ...
    /**
     */
    public inc.roguelike.babusya.network.Empty sendMessage(inc.roguelike.babusya.network.Message request) {
  ...
  public static final class GameFutureStub extends io.grpc.stub.AbstractFutureStub<GameFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<inc.roguelike.babusya.network.Empty> sendMessage(
        inc.roguelike.babusya.network.Message request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RECEIVE_MESSAGE:
          serviceImpl.receiveMessage((inc.roguelike.babusya.network.Empty) request,
              (io.grpc.stub.StreamObserver<inc.roguelike.babusya.network.Message>) responseObserver);
          break;
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((inc.roguelike.babusya.network.Message) request,
              (io.grpc.stub.StreamObserver<inc.roguelike.babusya.network.Empty>) responseObserver);
          break;
        default:
  ...
  private static abstract class GameBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return inc.roguelike.babusya.network.Service.getDescriptor();
    }
